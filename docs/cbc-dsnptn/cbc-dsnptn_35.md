...
![备忘录模式的结构图](img/9b9f56a1605194b80291c37089ab0638.jpg)
图 1 备忘录模式的结构图
...
![相亲游戏的结构图](img/ee360f217dbd870f12dcfe9b188c4c6f.jpg)
图 2 相亲游戏的结构图
程序代码如下：
...
![相亲游戏的运行结果](http://c.biancheng.net/uploads/allimg/181119/3-1Q1191305555M.jpg)
图 3 相亲游戏的运行结果（[点此查看原图](http://c.biancheng.net/uploads/allimg/181119/3-1Q1191305555M.jpg)）
...
![带原型的备忘录模式的结构图](img/698fdd515311c32855cbfebaa87de60c.jpg)
图 4 带原型的备忘录模式的结构图
实现代码如下：
