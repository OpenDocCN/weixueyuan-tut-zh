...
![办理房产证过户的相关部门](img/2a22b10acae7d2b18197a001c5ac04a2.jpg)
图 1 办理房产证过户的相关部门
...
![外观模式的结构图](img/9cf6eade656661be47d4d03e94956157.jpg)
...
class SubSystem01
{
    public  void method1()
    {
        System.out.println("子系统 01 的 method1()被调用！");
    }   
}
//子系统角色
class SubSystem02
{
    public  void method2()
    {
        System.out.println("子系统 02 的 method2()被调用！");
    }   
}
//子系统角色
class SubSystem03
{
    public  void method3()
    {
        System.out.println("子系统 03 的 method3()被调用！");
    }   
}
```
...
```
子系统 01 的 method1()被调用！
子系统 02 的 method2()被调用！
子系统 03 的 method3()被调用！
```
...
![婺源特产管理界面的结构图](img/18572ab73a92f2510317302affac32e4.jpg)
图 3 婺源特产管理界面的结构图
程序代码如下：
...
public class WySpecialtyFacade
{
    public static void main(String[] args)
    {
        ...
        splitpane.setDividerLocation(230);     //设置 splitpane 的分隔线位置
        splitpane.setOneTouchExpandable(true); //设置 splitpane 可以展开或收起                       
        cp.add(splitpane);
        f.setSize(650,350);
        f.setVisible(true);   
...
![婺源特产管理界面的运行结果](img/ca17ba3ada3041ec48b942085cc64405.jpg)
图 4 婺源特产管理界面的运行结果
...
![引入抽象外观类的外观模式的结构图](img/d0712887e7404022429e6270cee4b3f4.jpg)
