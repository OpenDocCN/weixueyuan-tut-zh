...
![类适配器模式的结构图](img/1574ee9ad9a6e68bb57a7ce1e9d87556.jpg)
图 1 类适配器模式的结构图
对象适配器模式的结构图如图 2 所示。

![对象适配器模式的结构图](img/6849d4ee58cdccbc802e55072b7975ed.jpg)
图 2 对象适配器模式的结构图
...
![发动机适配器的结构图](img/858fef2474f8ebf3e0937669264386bb.jpg)
图 3 发动机适配器的结构图
程序代码如下：
...
![双向适配器模式的结构图](img/c4813697c9645e8a83e610b09861e36e.jpg)
图 4 双向适配器模式的结构图
程序代码如下：
