...
![模板方法模式的结构图](img/8471febbd6d8d00be7c935c381753f4c.jpg)
图 1 模板方法模式的结构图
...
abstract class AbstractClass
{
    ...
    public abstract void abstractMethod1(); //抽象方法 1
    public abstract void abstractMethod2(); //抽象方法 2
}
//具体子类
...
![出国留学手续设计程序的结构图](img/5685af232520825e38c6de0928ccc59a.jpg)
图 2 出国留学手续设计程序的结构图
程序代码如下：
...
class StudyInAmerica extends StudyAbroad
{
    ...
    public void ApplyForEnrol()
    {
        ...
        System.out.println("  3）为了给签证办理留有充裕的时间，建议越早申请越好，一般提前 1 年就比较从容。");       
    }
    @Override
...
二.入学申请：
  ...
  3）为了给签证办理留有充裕的时间，建议越早申请越好，一般提前 1 年就比较从容。
三.办理因私出国护照、出境卡和公证：
...
![含钩子方法的模板方法模式的结构图](img/75e779ed78b84233b371165c3c6e7d0b.jpg)
...
abstract class HookAbstractClass
{
    ...
    public void HookMethod1(){}  //钩子方法 1
    public boolean HookMethod2() //钩子方法 2
    {
        return true;
    }
    public abstract void abstractMethod1(); //抽象方法 1
