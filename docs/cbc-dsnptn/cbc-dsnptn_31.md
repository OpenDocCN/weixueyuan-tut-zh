...
![观察者模式的结构图](img/c7fc2a8ae519ef63dd0461937cfd9dec.jpg)
图 1 观察者模式的结构图
...
![人民币汇率分析程序的结构图](img/37b55910c2aa19e2fa65f29fd234c003.jpg)
图 2 人民币汇率分析程序的结构图
程序代码如下：
...
![学校铃声的事件模型图](img/fda8aedd8d5de2653c03f9bc890c0497.jpg)
图 3 学校铃声的事件模型图
...
![学校铃声事件处理程序的结构图](img/35f5f6309c1212cbbbfa364a8452e05d.jpg)
图 4 学校铃声事件处理程序的结构图
程序代码如下：
...
![原油期货的观察者模式实例的结构图](img/b4b69d10e553442aeabe0c63751ba66b.jpg)
