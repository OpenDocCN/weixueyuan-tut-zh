...
![“几维鸟不是鸟”实例的类图](img/0a9dd1d405f94b98d84534f6cbb98d87.jpg)
图 1 “几维鸟不是鸟”实例的类图
程序代码如下：
...
public class LSPtest
{
    public static void main(String[] args)
    {
        ...
        bird1.setSpeed(120);
        bird2.setSpeed(120);
        System.out.println("如果飞行 300 公里：");
        try
        {
...
![“几维鸟是动物”实例的类图](img/046d1b4de54635eca57bc17691dbd54f.jpg)
图 2 “几维鸟是动物”实例的类图