...
> 原文：[`c.biancheng.net/view/6411.html`](http://c.biancheng.net/view/6411.html)
...
![IP 数据报格式示意图](img/ccfb4add5efd3741710d0678b5ce42fc.png)
...
首部和数据之和，单位为字节。总长度字段为 16 位，因此数据报的最大长度为 2¹⁶-1=65535 字节。
