...
> 原文：[`c.biancheng.net/view/6441.html`](http://c.biancheng.net/view/6441.html)

TCP 报文是 TCP 层传输的数据单元，也称为报文段。TCP 报文中每个字段如图所示。![](img/62fa1235216b3d46c6370b54c83c9eda.png)上图中 TCP 报文中每个字段的含义如下：
